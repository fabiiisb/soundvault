...
import SingleCardOptions from '@/components/private/SingleCardOptions'
...
const PrivSingles = () => {
  ...
  if (!singleData) {
    return (
      <>
        <h1 className='text-2xl pb-2 font-bold underline underline-offset-[3px] decoration-niceOrange-400 decoration-2'>Edit singles</h1>
