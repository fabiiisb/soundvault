'use client'
import { Card, Image, CardFooter, Link as LinkUi } from '@nextui-org/react'
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <CardFooter className=" before:bg-white/10 border-white/20 border-1 overflow-hidden py-1 absolute before:rounded-xl rounded-lg bottom-1 w-[calc(100%_-_8px)] shadow-small ml-1 z-10">
