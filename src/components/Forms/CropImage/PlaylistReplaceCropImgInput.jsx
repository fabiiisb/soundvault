...
const PlaylistReplaceCropImgInput = ({ actualImage, id }) => {
  ...
  const fetchReplaceImage = async (img) => {
    ...
    fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/private/imagePlaylist/${id}`,
      {
        method: 'PUT',
        body: formData
      }
...
export default PlaylistReplaceCropImgInput
